...
def parse_args():
    ...
    parser.add_argument("--candidates_file", type=str, default=None,
                        help="Override cfg[candidates_file]")
    parser.add_argument("--scored_file", type=str, default=None,
                        help="Override cfg[scored_file]")
...
def main():
    ...
    if args.candidates_file:
        cfg["candidates_file"] = args.candidates_file
    if args.scored_file:
